...
public class StudentDAOImpl implements StudentDAO {
	...
	public void insert(Student student) throws SQLException {
		inputString  ="insert into student values("+student.getId()+",'"+student.getName()+"','"+student.getClassStr()+"',"+student.getMarks()+")";
	...
	@Override
	//	update student set name='Abhishek Bajpai','Aviation and Aeronautical Sciences',99.95 where id=1)

	public void update(Student student) throws SQLException {
		inputString = "update student set name='"+ student.getName() +"', class='"+ student.getClassStr()+"', marks=" + student.getMarks() + " where id=" + student.getId();
		System.out.println("\t" + inputString);
		statement.executeUpdate(inputString);
